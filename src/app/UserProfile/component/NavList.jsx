  ...
  return (
    <div className='w-[100%] h-[auto] my-2'>
      ...
      props.title? (
        ...
        {
          props.item.map((item) => (
            <div  className={ !item.important? item.active? `bg-[#6793da89] text-[#4086ee] font-semibold h-[30px] w-[100%] flex  text-[14px] font-nunito text-left rounded-full `:`h-[30%] w-[100%] text-${item.important ? `[#ff2b2b]`:`[#5f5d5db6]` } flex items-center  text-[14px] font-nunito text-left rounded-full hover:bg-[#6793da89] hover:text-[#4086ee] font-semibold hover:transition-all transition-all mt-[1rem]`: `h-[30%] w-[100%] text-${item.important ? `[#ff2b2b]`:`[#5f5d5db6]` } flex items-center  text-[14px] font-nunito text-left mt-[1rem] hover:cursor-pointer font-semibold` }>
